...
export interface TrainMetaProps extends React.HTMLAttributes<HTMLDivElement> {
  items: Array<{
    label: string;
...
export const TrainMeta = React.forwardRef<HTMLDivElement, TrainMetaProps>(
...
TrainMeta.displayName = "TrainMeta";
